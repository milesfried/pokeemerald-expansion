...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_TUNNELGUIDESETSTEALTHROCK]            = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s Tunnel Guide scattered pointed stones around {B_DEF_TEAM2} team!"),
    [STRINGID_TUNNELGUIDEHEALED]                    = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s Tunnel Guide restored its HP!"),
